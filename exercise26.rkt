...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname exercise23) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
(define original-ticket-price 5.0)
(define ticket-price-rate-of-change (/ 15 0.1))
(define original-attendance 120)
(define original-cost 180)
(define cost-rate-of-change 0.04)
