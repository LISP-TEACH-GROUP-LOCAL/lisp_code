...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname exercise83) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
(require 2htdp/image)
...
(si-render (make-aim (make-posn (/ width 2) 0) (make-tank (/ width 2) 3)))